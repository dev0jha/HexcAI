...
function ClientFeedback() {
   ...
   return (
      <section ref={testimonialRef} className="relative container mx-auto h-full py-14">
         ...
         <div className="flex w-full flex-col gap-2 px-4 pt-10 pb-4 lg:grid lg:grid-cols-3 lg:px-10 lg:py-10">
            ...
            <div className="flex h-full flex-col gap-2 lg:gap-0 lg:space-y-2">
               ...
               >
                  ...
                  <article className="mt-auto">
                     <p>
                        &quot;For the first time, my skills were judged by my code — not just my
                        resume. The AI insights felt accurate and motivating.&quot;
                     </p>

                     <div className="flex justify-between pt-5">
                        <div>
                           <h2 className="text-sm font-semibold lg:text-xl">DEV HARI OJHA</h2>
               ...
               >
                  <article className="mt-auto">
                     <p>
                        &quot;The developer score helped me understand where I stand and how to
                        improve.&quot;
                     </p>
                  ...
                  >
                     <article className="mt-auto">
                        ...
                        <div className="flex items-end justify-between pt-5">
                           <div>
                              <h2 className="text-lg font-semibold lg:text-xl">{item.name}</h2>
                              <p className="text-sm lg:text-base">Developer {item.profession}</p>
                           </div>
            ...
            <div className="flex h-full flex-col gap-2 lg:gap-0 lg:space-y-2">
               ...
               >
                  <article className="mt-auto">
                     <p>
                        &quot;My GitHub finally mattered. HireXAI turned real projects into a
                        meaningful developer profile.&quot;
                     </p>
               ...
               >
                  ...
                  <article className="mt-auto">
                     <p>
                        &quot;The AI feedback pushed me to write cleaner, more maintainable
                        code.&quot;
                     </p>
