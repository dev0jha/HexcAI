...
export const HeroSection = () => {
  ...
  const people = [
  {
    ...
    image:
      "https://avatars.githubusercontent.com/u/118053362?v=4",
  },
  {
    id: 2,
    name: "Dev Hari Ojha",
    ...
    image:
      "https://pbs.twimg.com/profile_images/2007479757957701632/kPeohrWe_400x400.jpg",
  },
  {
    id: 3,
    name: "Pallav Rai",
    ...
    image:
      "https://avatars.githubusercontent.com/u/33592027?v=4",
  },
        ...
        >
          ...
          >
            <motion.div animate={{ rotate: [0, 15, -15, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-black dark:text-white">
            ...
            <span className="tracking-widest uppercase text-zinc-500 dark:text-zinc-400">HireXAI</span>
          </motion.div>
          ...
          >
            Revolutionize your hiring process with AI-driven code assessments that identify top talent quickly and accurately.
          </motion.p>
           <div className="flex flex-row items-center justify-center gap-6 mb-10 w-full">
               <AnimatedTooltip items={people} />
               <span className="text-sm sm:text-base font-light text-zinc-600 dark:text-zinc-400">+100 developers used</span>
           </div>
          {/* CTA Button */}
          <motion.div
            initial={{ opacity: 0, y: 15, scale: 0.95 }}
